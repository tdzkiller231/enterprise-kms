...
const MOCK_CATEGORIES: Category[] = [
  ...
  },
  {
    id: 'c6',
    code: 'EXP-KNOW',
    name: 'Tri thức chuyên gia',
    description: 'Kho tri thức đúc kết từ thực tiễn chuyên môn, sự cố và bài học kinh nghiệm.',
    status: 'Active',
    parentId: null,
    expertId: 'u1',
    expertName: 'Nguyễn Văn A (Admin)',
  ...
  },
  {
    ...
    code: 'EXP-KNOW-PROC',
    name: 'Quy trình',
    description: 'Các quy trình thực thi được chuẩn hoa tu kinh nghiem chuyen gia.',
    status: 'Active',
    parentId: 'c6',
    parentName: 'Tri thức chuyên gia',
    expertId: 'u1',
    expertName: 'Nguyễn Văn A (Admin)',
    docCount: 0,
    pendingDocCount: 0,
  ...
  },
  {
    ...
    code: 'EXP-KNOW-EXP',
    name: 'Kinh nghiệm',
    description: 'Kinh nghiem thuc te trong van hanh, quan ly va trien khai cong viec.',
    status: 'Active',
    parentId: 'c6',
    parentName: 'Tri thức chuyên gia',
    expertId: 'u1',
  ...
  },
  {
    ...
    code: 'EXP-KNOW-INC',
    name: 'Sự cố',
    description: 'Tong hop su co da xay ra, nguyen nhan goc va cach xu ly.',
    status: 'Active',
    parentId: 'c6',
    parentName: 'Tri thức chuyên gia',
    expertId: 'u1',
  ...
  },
  {
    ...
    code: 'EXP-KNOW-CASE',
    name: 'Case study',
    description: 'Cac tinh huong dien hinh va bai hoc rut ra tu truong hop cu the.',
    status: 'Active',
    parentId: 'c6',
    parentName: 'Tri thức chuyên gia',
    expertId: 'u1',
  ...
  },
  {
    ...
    description: 'Bai hoc kinh nghiem sau du an/su co de ngua lap lai va toi uu hoa.',
    status: 'Active',
    parentId: 'c6',
    parentName: 'Tri thức chuyên gia',
    expertId: 'u1',
...
let MOCK_COLLECTED_DOCUMENTS: CollectedDocument[] = [
  {
    ...
    fileSize: 2450000,
    filePath: 'BaoTri_ThietBi_2024/Quy_trinh_bao_tri_thiet_bi.pdf',
    source: 'Email',
  ...
  },
  {
    ...
    fileSize: 5200000,
    filePath: 'BaoTri_ThietBi_2024/ISO_9001_2015_Guidelines.pdf',
    source: 'GoogleDrive',
  ...
  },
  {
    ...
    fileSize: 620000,
    filePath: 'QA_Checklist_Thang12/Checklist_kiem_tra_chat_luong.xlsx',
    source: 'SharePoint',
  ...
  },
  {
    ...
    fileSize: 8900000,
    filePath: 'QA_Checklist_Thang12/Training_Material_Safety.pptx',
    source: 'Other',
...
export const KMSService = {
  ...
  uploadCollectedDocuments: async (data: {
    ...
    const newDocs: CollectedDocument[] = data.files.map(file => ({
      ...
      fileName: file.name,
      fileSize: file.size,
      filePath: (file as File & { webkitRelativePath?: string }).webkitRelativePath || undefined,
      source: data.source,
